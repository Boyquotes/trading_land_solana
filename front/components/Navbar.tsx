    ...
    <section className="w-full">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2 py-4">
          <picture>
            <source srcSet="/LogoFlatDark.png" media="(prefers-color-scheme: dark)" />
            <Image
              src="/LogoFlat.png"
              alt="Logo"
              width={50}
              height={50}
              className="transition-transform duration-300 hover:scale-110 hover:opacity-80 hover:rotate-180 rounded-xl shadow-md dark:filter dark:invert dark:brightness-90"
            />
          </picture>
          <div className="flex flex-col">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-200 ml-1">Trading game on solana. Enjoy!!</span>
          </div>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          <a href="https://discord.gg/kPhgtj49U2" target="_blank" rel="noopener noreferrer">
            <svg
              ...
              viewBox="0 0 640 512"
              className="h-6 w-6 text-gray-800 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300"
            >
